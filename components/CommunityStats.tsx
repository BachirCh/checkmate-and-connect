    ...
    <section className="w-full bg-white py-16 sm:py-24">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="grid grid-cols-3 gap-6 mt-12 text-center">
          <div>
            <div className="text-4xl sm:text-5xl font-bold text-blue-600 mb-2">2+</div>
            <div className="text-sm sm:text-base text-gray-600 uppercase tracking-wide">Years Running</div>
          </div>
          <div>
            <div className="text-4xl sm:text-5xl font-bold text-blue-600 mb-2">200+</div>
            <div className="text-sm sm:text-base text-gray-600 uppercase tracking-wide">Members</div>
          </div>
          <div>
            <div className="text-4xl sm:text-5xl font-bold text-blue-600 mb-2">Weekly</div>
            <div className="text-sm sm:text-base text-gray-600 uppercase tracking-wide">Meetups</div>
          </div>
        </div>
      </div>
    </section>
