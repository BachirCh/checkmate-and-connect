/**
 * Phosphor Regular icons, inlined.
 *
 * The brand calls for Phosphor Regular (GL 12). We inline the handful of paths
 * we actually use rather than pulling in @phosphor-icons/react — the package
 * ships ~1,500 icons and every kilobyte counts against the Cloudflare Worker's
 * 3 MiB ceiling.
 *
